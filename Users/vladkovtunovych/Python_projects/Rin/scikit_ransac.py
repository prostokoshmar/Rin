...
if __name__ == "__main__":
    ...
    TILE_DIR = "/Users/vladkovtunovych/Downloads/Z_png_O2A"  # Replace with your folder path
    MATCH_VIS_DIR = os.path.join(TILE_DIR, "match_vis_skimage")
    matching_ratio = 0.1 #Percentage of lines that must be valid
    matching_angle = 10 # Max angle deviation in degrees
    min_matches = 4  
    len_gap = 20  # Max length deviation in pixels
    selected_method = "sift"  # Choice of method for final offsets(sift is the best)
